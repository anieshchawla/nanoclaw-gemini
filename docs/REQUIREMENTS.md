...
I don't need an installation wizard - Gemini Code guides the setup. I don't need a monitoring dashboard - I ask Gemini Code what's happening. I don't need elaborate logging UIs - I ask Gemini to read the logs. I don't need debugging tools - I describe the problem and Gemini fixes it.
...
**Core components:**
- **Gemini Agent SDK** as the core agent
...
- Use existing tools (WhatsApp connector, Gemini Agent SDK, MCP servers)
- Minimal glue code
...
### Session Management
- Each group maintains a conversation session (via Gemini Agent SDK)
...
- Tasks execute Gemini Agent SDK in containerized group context

### Web Access
- Built-in WebSearch and WebFetch tools
- Standard Gemini Agent SDK capabilities
...
- Setup and customization done via Gemini Code
- Users clone the repo and run Gemini Code to configure
